...
#Menu .level1 .level1Style {
  background: url("../detail/style/images/img/menu_btn_bg.gif") no-repeat scroll 0 0 transparent;
    height: 23px;
    padding-left: 20px;
    padding-top: 5px;
    width: 135px;
...
#Menu .level1 .MenuLevel2 .level2Style{
	...
	padding-top: 5px;
	width: 112px;
	background-image:url(../detail/style/images/img/menu_arrow_single.gif);
    ...
    <ul id="Menu">
	    <li class="level1">
            <div onClick="menuClick(this);" class="level1Style">
				<img src="../detail/style/images/func20001.gif" class="Icon" />
				系统菜单
			</div>
            <ul class="MenuLevel2">
				<c:forEach items="${sessionScope.rights}" var="right">
					<c:if test="${right.rightname != null}">
						<li class="level2 level2Style">
							<a target="right" href="${right.righturi}?method=1">${right.rightname}</a>
						</li>
					</c:if>
				</c:forEach>
            	<%--<li class="level2 level2Style">--%>
                    <%--<a target="right" href="boardList.jsp">餐桌管理</a>--%>
				<%--</li>--%>
                <%--<li class="level2 level2Style">--%>
				<%--</li>--%>
                <%--<li class="level2 level2Style">--%>
                	<%--<a target="right" href="foodList.jsp">菜品管理</a>--%>
				<%--</li>--%>
                <%--<li class="level2 level2Style">--%>
                	<%--<a target="right" href="orderList.jsp">餐厅订单</a>--%>
				<%--</li>--%>
            </ul>
        </li>
    </ul>
