...
function addTr(){
    // 创建一个行tr
    var $tr = $("<tr></tr>");
    $tr.append("<td align='center'>'${food.id}'&nbsp;</td>")
        .append("<td align='center'>${food.name}&nbsp;</td>")
        .append("<td align='center'>${food.foodset}&nbsp;</td>")
        .append("<td align='center'>${food.price}&nbsp;</td>")
        .append("<td align='center'>${food.vipprice}&nbsp;</td>")
        .append("<td><a href='/GetFoodServlet?foodId=${food.id}'class=\"FunctionButton\">删除</a></td>")
		.appendTo("#"+id);
}
